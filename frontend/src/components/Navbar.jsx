      ...
      {!hideButtons && (
        ...
        >
          <button
            ...
            className="bg-primary font-outfit text-white px-10 py-3 rounded-full font-light hidden xl:block hover:bg-[#44becf] transition md:max-lg:px-6 md:max-lg:py-2"
          >
            Create Account
          </button>
          <button
          ...
          >
            ...
            {!hideButtons && (
              <div className="flex flex-col items-start gap-4">
                <button
                  onClick={() => navigate('/roleselection')}
                  className="bg-primary font-outfit text-white px-10 py-3 rounded-full font-light hover:bg-[#44becf] transition w-full"
                >
                  Create Account
                </button>
                <button
                  onClick={() => navigate('/login')}
                  className="bg-secondary font-outfit text-white px-10 py-3 rounded-full font-light hover:bg-[#44becf] transition w-full"
                >
                  Login
                </button>
              </div>
