    ...
    <div className="w-full flex flex-col items-center space-y-16">
      ...
      <div className="relative w-full overflow-hidden">
        ...
        <button
          ...
          className="absolute top-2/3 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-primary text-white font-light py-3 px-8 rounded-full shadow-lg hover:bg-[#44becf] transition-all duration-300 font-outfit"
