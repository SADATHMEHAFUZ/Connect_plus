...
function StudentReg() {
      ...
      <div className="container mx-auto py-16 font-outfit">
        ...
        <form onSubmit={submitForm} className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-8">
          ...
          {/* <div className="col-span-1 md:col-span-2 flex justify-center">
            <button type="submit" className="bg-primary font-outfit text-white px-10 py-3 rounded-full font-light hover:bg-[#44becf] transition">
              Create Account
            </button>
          </div> */}
  ...
  <button
    type="submit"
    className="bg-primary font-outfit text-white px-10 py-3 rounded-full font-light hover:bg-[#44becf] transition"
    onClick={() => {
